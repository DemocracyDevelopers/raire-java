...
public abstract sealed class RaireError {
    ...
    public static final class InvalidNumberOfCandidates extends RaireError {}
     ...
     * error is generated. */
    public static final class InvalidTimeout extends RaireError {}
    ...
    public static final class InvalidCandidateNumber extends RaireError {}
    ...
    public static final class TimeoutCheckingWinner extends RaireError {}
     ...
     * will be generated. All three stages must be completed within the specified time limit
     * or a relevant timeout error will be generated. */
    public static final class TimeoutFindingAssertions extends RaireError { public final double difficultyAtTimeOfStopping;
    ...
    public static final class TimeoutTrimmingAssertions extends RaireError {}
    ...
    public static final class TiedWinners extends RaireError { public final int[] expected;
    ...
    public static final class WrongWinner extends RaireError { public final int[] expected;
    ...
    public static final class CouldNotRuleOut extends RaireError { public final int[] eliminationOrder;
    ...
    public static final class InternalErrorRuledOutWinner extends RaireError {}
    ...
    public static final class InternalErrorDidntRuleOutLoser extends RaireError {}
    ...
    public static final class InternalErrorTrimming extends RaireError {}
